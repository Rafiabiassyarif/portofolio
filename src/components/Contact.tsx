      ...
      <div className="flex flex-col items-center justify-center text-center w-full relative z-10">
        ...
        >
          ...
          <span className="relative z-10 flex items-center">
            {t.contact.emailMe || (language === 'id' ? "Email Saya" : "Email Me")} <ArrowUpRight className="w-8 h-8 ml-4 transition-transform duration-300 group-hover:translate-x-2 group-hover:-translate-y-2" />
          </span>
        </a>
      </div>
